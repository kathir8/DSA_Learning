...
class LinkedList {
    ...
    findMiddle() {
        ...
        return slow.val; // Middle node's value
    }
...
const inp = [list1.append(1), list1.append(2), list1.append(3), list1.append(4), list1.append(5)];
...
if(currentNode1.val < currentNode2.val){
    out.append(currentNode1.val);
}else{
    out.append(currentNode2.val);
}
